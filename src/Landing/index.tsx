...
function Landing() {
    ...
    return (
      <div className="landing">
        ...
        <div className="dark-gray-background">
            <div className={AppState.appDimensions.innerWidth <= 500 ? "landingRow-3-mobile" : "landingRow-3"}>
                <div className="landing-header-1">RugSeekers has been featured in</div>
            </div>
        </div>
        <div className="dark-gray-background">
            <div className={AppState.appDimensions.innerWidth <= 500 ? "landingRow-4-mobile" : "landingRow-4"}>
