        ...
        <div className="dapp">
            ...
            <div className="section-3">
                <div className="token-rewards">
                    ...
                    <div className="claimable-rewards-2" style={{
                        height: "80px"
                    }} >
                    <Section icon={questionIcon} title="Select one option below in which form would you like to receive your
                        rewards. Click the (?) for more detailed info" value=""/>
                    </div>
                            <div className="claim-rewards-as" onClick={async () => {
